...
public class Engine {
    ...
    public void loadIndex(){
        ...
        try {
            docs= new File("A:\\SearchEngine\\DocID.json");
            forward=new File("A:\\SearchEngine\\ForwardIndex.json");
            Lexicons=new File("A:\\SearchEngine\\Lexicons.json");
            try {
                ...
                System.out.println("Well it's empty huh");
            }
        }
        catch(Exception e){
            e.printStackTrace();
 ...
 */
    ...
    public void createReverseIndex() throws IOException {//Creates ReverseIndex
        ...
        saveFiles("A:\\SearchEngine\\InvertedIndex.json",invertedIndex);
